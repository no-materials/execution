...
/// Flat operand encoding table indexed by `OperandLayout`.
pub const OPERAND_ENCODINGS: &[OperandEncoding] = &[
    OperandEncoding::RegU32Uleb,
    OperandEncoding::RegU32Uleb,
    OperandEncoding::U32Uleb,
    OperandEncoding::RegU32Uleb,
    OperandEncoding::RegU32Uleb,
    OperandEncoding::BoolU8,
    OperandEncoding::RegU32Uleb,
    OperandEncoding::I64Sleb,
    OperandEncoding::RegU32Uleb,
    OperandEncoding::U64Uleb,
    OperandEncoding::RegU32Uleb,
    OperandEncoding::U64Le,
    OperandEncoding::RegU32Uleb,
    OperandEncoding::I64Sleb,
...
impl Opcode {
    ...
    #[must_use]
    pub fn operand_encodings(self) -> &'static [OperandEncoding] {
        let layout = self.info().operands;
        let start = usize::from(layout.start);
        let end = start + usize::from(layout.len);
        &OPERAND_ENCODINGS[start..end]
    }
}
