...
impl OperandSchema {
    const fn new(kind: OperandKind, role: OperandRole, encoding: OperandEncoding) -> Self {
        Self { kind, role, encoding }
    }
}
...
pub const OPERANDS: &[OperandSchema] = &[
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Src, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::ImmU32, OperandRole::TrapCode, OperandEncoding::U32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::ImmBool, OperandRole::Imm, OperandEncoding::BoolU8),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::ImmI64, OperandRole::Imm, OperandEncoding::I64Sleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::ImmU64, OperandRole::Imm, OperandEncoding::U64Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::ImmU64, OperandRole::Bits, OperandEncoding::U64Le),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::ImmI64, OperandRole::Mantissa, OperandEncoding::I64Sleb),
    OperandSchema::new(OperandKind::ImmU8, OperandRole::Scale, OperandEncoding::U8Raw),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::ConstId, OperandRole::Const, OperandEncoding::U32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::A, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::B, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::A, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::B, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    ...
    OperandSchema::new(OperandKind::Reg, OperandRole::B, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Cond, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::A, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::B, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::A, OperandEncoding::RegU32Uleb),
    ...
    OperandSchema::new(OperandKind::Reg, OperandRole::B, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Cond, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Pc, OperandRole::PcTrue, OperandEncoding::U32Uleb),
    OperandSchema::new(OperandKind::Pc, OperandRole::PcFalse, OperandEncoding::U32Uleb),
    OperandSchema::new(OperandKind::Pc, OperandRole::PcTarget, OperandEncoding::U32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::EffOut, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::FuncId, OperandRole::Func, OperandEncoding::U32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::EffIn, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::RegList, OperandRole::Args, OperandEncoding::RegListU32UlebCountThenRegs),
    OperandSchema::new(OperandKind::RegList, OperandRole::Rets, OperandEncoding::RegListU32UlebCountThenRegs),
    OperandSchema::new(OperandKind::Reg, OperandRole::EffIn, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::RegList, OperandRole::Rets, OperandEncoding::RegListU32UlebCountThenRegs),
    OperandSchema::new(OperandKind::Reg, OperandRole::EffOut, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::HostSigId, OperandRole::HostSig, OperandEncoding::U32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::EffIn, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::RegList, OperandRole::Args, OperandEncoding::RegListU32UlebCountThenRegs),
    OperandSchema::new(OperandKind::RegList, OperandRole::Rets, OperandEncoding::RegListU32UlebCountThenRegs),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::RegList, OperandRole::Values, OperandEncoding::RegListU32UlebCountThenRegs),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Tuple, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::ImmU32, OperandRole::Index, OperandEncoding::U32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::TypeId, OperandRole::Type, OperandEncoding::U32Uleb),
    OperandSchema::new(OperandKind::RegList, OperandRole::Values, OperandEncoding::RegListU32UlebCountThenRegs),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::St, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::ImmU32, OperandRole::FieldIndex, OperandEncoding::U32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::ElemTypeId, OperandRole::ElemType, OperandEncoding::U32Uleb),
    OperandSchema::new(OperandKind::RegList, OperandRole::Values, OperandEncoding::RegListU32UlebCountThenRegs),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Arr, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Arr, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Index, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Tuple, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::St, OperandEncoding::RegU32Uleb),
    ...
    OperandSchema::new(OperandKind::ImmU32, OperandRole::Index, OperandEncoding::U32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Bytes, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::S, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::A, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::B, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    ...
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Bytes, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Start, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::End, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Dst, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::S, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::Start, OperandEncoding::RegU32Uleb),
    OperandSchema::new(OperandKind::Reg, OperandRole::End, OperandEncoding::RegU32Uleb),
